Public Class Form21
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "Campolide" Then
            TextBox5.Text = FormatNumber(0.65 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Santa Cruz - Damaia" Then
            TextBox5.Text = FormatNumber(0.8 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Massamá - Barcarena" Then
            TextBox5.Text = FormatNumber(0.95 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Mercês" Then
            TextBox5.Text = FormatNumber(1.1 * TextBox4.Text, 2) & "€"
        End If
