Public Class Form23
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If TextBox1.Text = "Campolide" Then
            TextBox5.Text = FormatNumber(0.35 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Santa Cruz - Damaia" Then
            TextBox5.Text = FormatNumber(0.4 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Massamá - Barcarena" Then
            TextBox5.Text = FormatNumber(0.5 * TextBox4.Text, 2) & "€"
        End If
        ...
        If TextBox1.Text = "Mercês" Then
            TextBox5.Text = FormatNumber(0.55 * TextBox4.Text, 2) & "€"
        End If
